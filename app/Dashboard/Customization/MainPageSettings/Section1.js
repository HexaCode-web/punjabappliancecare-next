...
const Section1 = ({ FetchedData, UpdateData, SpecialStyles, setOuterData }) => {
  ...
  const handlePrimaryAction = () => {
    ...
    if (SpecialStyles) {
      setOuterData((prev) => {
        return {
          ...prev,
          Section1: { ...prev.Section1, Cards: [...prev.Cards, NewCard] },
        };
      });
    }
  ...
  const handleInput = async (e) => {
    ...
    if (SpecialStyles) {
      setOuterData((prev) => {
        return { ...prev, Section1: { ...prev.Section1, [name]: value } };
      });
    }
  };
  const CheckCards = () => {
  ...
  const DeleteCard = (id) => {
    ...
    if (SpecialStyles) {
      setOuterData((prev) => {
        return { ...prev, Section1: { ...prev.Section1, Cards: NewCards } };
      });
    }
  };
  const columns = [
  ...
  const TableData = data.Cards.map((Card) => {
    const handleChange = (e) => {
      ...
      if (SpecialStyles) {
        setOuterData((prev) => {
          return { ...prev, Section1: { ...prev.Section1, Cards: newData } };
        });
      }
    };
  ...
  const handleCheckboxChange = () => {
    ...
    if (SpecialStyles) {
      setOuterData((prev) => {
        return {
          ...prev,
          Section1: { ...prev.Section1, Show: !prev.Section1.Show },
        };
      });
    }
  };
